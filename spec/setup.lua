...
_G.Enum = {
  ...
  EditModeSystem = {
    ActionBar = 1,
    -- Canonical BUII enum IDs (must match EditModeUtils.lua)
    BUII_GroupTools = 110,
    BUIIQueueStatusButton = 111,
    BUII_PetReminder = 112,
    BUII_ArenaEnemyFrames = 113,
    BUII_StanceTracker = 114,
    BUII_TotemFrame = 115,
    BUII_CallToArms = 116,
    BUII_CombatState = 117,
    BUII_GearAndTalentLoadout = 118,
    BUII_ReadyCheck = 119,
    BUII_LootSpec = 120,
    BUII_TankShieldWarning = 121,
    BUII_StatPanel = 122,
    BUII_MissingBuffReminder = 123,
    BUII_ResourceTracker = 124,
  },
